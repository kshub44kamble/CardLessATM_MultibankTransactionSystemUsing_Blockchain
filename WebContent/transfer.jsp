...
String sql = "SELECT accno, acc_type FROM acc_details WHERE uname='"+uname+"'";
ArrayList one = BankCommons.getAccountByName(sql);
//System.out.println(one);
String sql_1 = "SELECT accno, acc_type FROM acc_details";
...
<p>&nbsp;</p>	</td>
	...
	<br/>
	<br/>
	<form id="form1" name="form1" method="post" action="dbTransfer">
	  <table width="80%" border="0" align="center" cellpadding="2" cellspacing="2">
        ...
        <tr>
          ...
          <td>:</td>
          <td><label>
            <input name="Amount" type="text" id="Amount" size="10" required />
          Rs.</label></td>
        </tr>
        <tr>
          ...
          <td>:</td>
          <td><label>
            <textarea name="textfield2" cols="30" rows="4" required></textarea>
          </label></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
