    ...
    <td colspan="2"><table width="98%" border="0" align="center" cellpadding="1" cellspacing="0">
      <tr>
        <th colspan="2" scope="col"><div class="box1">
          <marquee>
            <h2><font color="#FF0000">ATM Multibank</font></h2>
            </marquee>
        </div></th>
        </tr>
      <tr>
        ...
        <form id="form1" name="form1" method="post" action="doLogin">
          <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" style="border:#000000 solid 2px; padding:5px;">
            ...
            <tr>
              <td width="24%">Email_ID:</td>
              <td width="48%"><label>
                <input name="username" type="text" id="username" required  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" />
              </label></td>
            </tr>
            <tr>
              <td>Password:</td>
